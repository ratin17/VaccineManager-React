...
export class Features extends Component {
  render() {
    return (
      <div>
        <h2 className="stylish-regular text-5xl mt-5  text-pink-500 text-center font-bold">
          Our Features...
        </h2>
            ...
            <div className="grid gap-14 md:grid-cols-3 md:gap-5">
              <div className="rounded-xl bg-white p-6 text-center shadow-xl">
                ...
                <p className="px-4 text-gray-500">
                  Effortlessly oversee vaccination efforts with our
                  comprehensive management system. From scheduling to tracking,
                  ensure timely and effective immunizations with real-time
                  updates and detailed reporting.
                </p>
              </div>
              <div
                data-aos-delay="150"
              ...
              >
                ...
                <p className="px-4 text-gray-500">
                  Automate the vaccination scheduling process with ease.
                  Patients can book, receive reminders, and reschedule online,
                  minimizing no-shows and ensuring a smooth vaccination
                  experience.
                </p>
              </div>
              <div
              ...
              >
                ...
                <p className="px-4 text-gray-500">
                  Access and update vaccination records securely and
                  efficiently. Both healthcare providers and patients can
                  quickly view vaccination histories, ensuring everyone is
